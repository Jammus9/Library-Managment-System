        ...
        <?php include 'include/sidebar.php'; ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    ?>
                     <form method="post" action="validation/delete_book.php">
                     <?php
                     if (isset($_GET['id'])){
                          ...
                          <div class="col-6 form-group">
                              ...
                              <div class="col-6 form-group">
                                ...
                                <div class="col-6 form-group">
                                  ...
                                  <div class="col-6 form-group">
                                    <h2> Are You Sure You Wish to Delete Book</h2>
                                </div>
                          <div class="col-6 form-group">		
                          <button class="btn btn-primary" type="submit" name="delete_book">Delete BOOK</button>
                          </div>
                        </div>
                    </form>
